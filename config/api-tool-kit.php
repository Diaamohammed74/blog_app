    ...
    'groups_files_paths' => [
        'default' => [
            ...
            GeneratorFilesType::CONTROLLER => [
                'folder_path' => app_path('Http/Controllers/Api/V1/Client/{ModelName}'),
                'file_name'   => '{ModelName}Controller.php',
                'namespace'   => 'App\Http\Controllers\Api\V1\Client\{ModelName}',
            ],
            GeneratorFilesType::RESOURCE => [
                'folder_path' => app_path('Http/Resources/Client/{ModelName}'),
                'file_name'   => '{ModelName}Resource.php',
                'namespace'   => "App\Http\Resources\Client\{ModelName}",
            ],
            ...
            GeneratorFilesType::CREATE_REQUEST => [
                'folder_path' => app_path('Http/Requests/Client/{ModelName}'),
                'file_name'   => 'Create{ModelName}Request.php',
                'namespace'   => "App\Http\Requests\Client\{ModelName}",
            ],
            ...
            GeneratorFilesType::ROUTES => [
                'folder_path' => base_path('routes/api/v1/client'),
